		...
		<section class="grid_9">
			<div class="block-border"><div class="block-content">
				<h1>Board Room</h1>
						...
						<p style="text-align: justify;">Boardroom is the room where the <span style="color:#0083C3"><i>quarterly review</span></i> happens 
						and currently you are the person in hot seat. Here the top management
