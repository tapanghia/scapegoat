...
) ENGINE=MyISAM AUTO_INCREMENT=4131 DEFAULT CHARSET=latin1;
...
INSERT INTO `marklabs`.`rep_brand_map` VALUES  (1,0,'Alpha','AMAN',1.8,2,2.3,6.2,4.8,5),
 ...
 (3,0,'Bravo','BYAN',4,4.2,1.2,2,1.6,4);
UNLOCK TABLES;
...
) ENGINE=MyISAM AUTO_INCREMENT=6131 DEFAULT CHARSET=latin1;
...
INSERT INTO `marklabs`.`salesforce` VALUES  (6000,2000,25.0000,25.0000,25.0000),
 ...
 (6100,2100,38.0000,100.0000,75.0000),
 ...
 (6120,2124,25.0000,0.0000,75.0000),
...
INSERT INTO `marklabs`.`teams` VALUES  (1,'Alpha','Alpha','Alpha',1,630397),
